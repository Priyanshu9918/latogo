...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                <!-- <a href="/admin/contact_videos/create" class="btn btn-primary btn-rounded cu">
                    <i class="fa fa-plus-circle mr-1"></i>
                    <span style="bottom: 3px; position: relative;"> Add Contact Video</span></a> -->
                <h4 class="card-title">Contact Video</h4>
                <div class="row">
                    <div class="col-12">
                    ...
                    $(document).ready(function() {
                        ...
                        if ($("#point-datatable").length > 0) {
                            ...
                            var targetDt = $('#point-datatable').DataTable({
                                processing: true,
                                serverSide: true,
                                ajax: "{{route('admin.contact_videos')}}",
