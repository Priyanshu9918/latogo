...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Manage Footer Text</h4>
    ...
    <div class="row">
      ...
      <div class="col-xxl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{route('admin.footer_texts.create')}}" method="POST" id="createFrm" enctype="multipart/form-data">
              @csrf
              <div class="row mb-3">
                ...
                <div class="col-sm-8">
                  <div class="input-group input-group-merge">
                    ...
                    <input type="text" class="form-control" name="address" id="basic-icon-default-address" />
                  </div>
            ...
            $.ajax({
              ...
              success: function(response) {
                ...
                if (response.success == true) {
                  //notify
                  toastr.success("Footer text created Successfully");

                  // Swal.fire({
                  //   position: 'top-end',
                  //   icon: 'success',
                  //   title: 'Footer text Created Successfully',
