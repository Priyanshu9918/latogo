...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Footer Text</h4>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Edit Footer Text</h5>
                    </div>
                    <div class="card-body">
                    <form action="{{ route('admin.footer_texts.edit',['id'=>base64_encode($footer_texts->id)]) }}" method="POST" id="editFrm" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" class="form-control" name="address" id="basic-icon-default-address" value="{{$footer_texts->address ?? ''}}"/>
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="email" class="form-control" name="email" id="basic-icon-default-email" value="{{$footer_texts->email ?? ''}}"/>
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              <input type="number" class="form-control" name="phone" id="basic-icon-default-phone" value="{{$footer_texts->phone ?? ''}}"/>
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              ...
                              <textarea type="text" class="summernote" class="form-control" name="description" id="basic-icon-default-fullname">{{$footer_texts->description}}</textarea>
                            </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(response.success==true) {
                        ...
                        //notify
                        toastr.success("Footer text updated Successfully");
                        // Swal.fire({
                        // position: 'top-end',
                        // icon: 'success',
                        ...
                        window.setTimeout(function() {
                            window.location = "{{ url('/')}}"+"/admin/footer_texts";
                        }, 2000);
