...
<style>
    ...
    left: 780px;
          ...
          <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                <!-- <a href="/admin/become_an_instructors/create" class="btn btn-primary btn-rounded bu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;">Add Why Online Teacher</span></a> -->
                    <h4 class="card-title"> Reason Why Online Teacher</h4>
                    <div class="row">
                    <div class="col-12">
    ...
    $(document).ready(function(){
        ...
        if ($("#banner-datatable").length > 0) {
            ...
            var targetDt = $('#banner-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route('admin.become_an_instructors')}}",
        ...
        $(document).on('click', '.statusBtn', function (event) {
            ...
            //  alert(user_id);
            var table = 'become_an_instructors';
            //alert('hello');
