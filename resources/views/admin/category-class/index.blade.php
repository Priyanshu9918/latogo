            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                        <h4 class="card-title m-0">Classes</h4>
                        <a href="/admin/category_class/create" class="btn btn-primary btn-rounded cu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;">  Add Class Category</span></a>
                    </div>
                    
                    <div class="row">
                    <div class="col-12">
                        <table id="category_class-datatable" class="table">
                        <thead style="background:#a0b8ed29;">
                            <tr>
                                <th> #</th>
                                <th><b>Class Category</b></th>
...
<script>
    $(document).ready(function(){
        ...
        if ($("#category_class-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#category_class-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route('admin.category_class')}}",
            ...
            $("#category_class-datatable").parent().addClass('table-responsive');

            /*Select all using checkbox*/
            var  DT1 = $('#category_class-datatable').DataTable();
                        ...
                        if(e==true)
                        {
                            ...
                            $.ajax({
                                ...
                                success: function(data){
                                    ...
                                    if(data.code==200)
                                    {
                                        toastr.success("Class category deleted Successfully");
                                        window.setTimeout(function(){
                                            window.location.reload();
                                        },2000);
                                    }
