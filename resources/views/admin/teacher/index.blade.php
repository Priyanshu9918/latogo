            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                        <h4 class="card-title m-0">Teacher</h4>
                        <a href="/admin/teacher/create" class="btn btn-primary btn-rounded cu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;"> Add Teacher</span></a>
                    </div>
                    <div class="row">
                    <div class="col-12">
                        <table id="teacher-datatable" class="table">
...
<script>
    $(document).ready(function(){
        ...
        if ($("#teacher-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#teacher-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route('admin.teacher')}}",
            ...
            $("#teacher-datatable").parent().addClass('table-responsive');

            /*Select all using checkbox*/
            var  DT1 = $('#teacher-datatable').DataTable();
