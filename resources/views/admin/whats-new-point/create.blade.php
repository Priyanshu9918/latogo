...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Manage WhatNewPoint</h4>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Add what newpoints</h5>
                    </div>
                    <div class="card-body">
                    <form action="{{route('admin.whats-new-point.create')}}" method="POST" id="createFrm" enctype="multipart/form-data">
                            @csrf
                        <div class="row mb-3">
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(response.success==true) {
                        ...
                        toastr.success("what's new point created Successfully");

                        // Swal.fire({
                        //     position: 'top-end',
                        //     icon: 'success',
                        //     title: "what's new point Created Successfully",
