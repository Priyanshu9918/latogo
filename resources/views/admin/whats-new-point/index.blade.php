...
<style>
    ...
    left: 760px;
          ...
          <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                <!-- <a href="/admin/whats-new-point/create" class="btn btn-primary btn-rounded cu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;"> Add What's new points</span></a> -->
                    <h4 class="card-title">What's new points</h4>
                    <div class="row">
                    <div class="col-12">
    ...
    $(document).ready(function(){
        ...
        if ($("#point-datatable").length > 0) {
            ...
            var targetDt = $('#point-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route('admin.whats-new-point')}}",
