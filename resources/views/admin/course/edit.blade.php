                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Edit Courses Banner</h5>
                    </div>
                    <div class="card-body">
                    <form action="{{ route('admin.course.edit',['id'=>base64_encode($course->id)]) }}" method="POST" id="editFrm" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" class="form-control" name="title" value="{{$course->title}}" id="basic-icon-default-fullname"/>
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                              <input type="text" class="form-control" name="course" value="{{$course->course}}" id="basic-icon-default-fullname"/>
                            </div>
                            <p style="margin-bottom: 2px;" class="text-danger error_container" id="error-title"></p>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                              <input type="text" class="form-control" name="country" value="{{$course->country}}" id="basic-icon-default-fullname"/>
                            </div>
                            <p style="margin-bottom: 2px;" class="text-danger error_container" id="error-title"></p>
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                              <input type="text" class="form-control" name="appreciations" value="{{$course->appreciations}}" id="basic-icon-default-fullname"/>
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                              <input type="file" class="form-control" name="image"  value="{{$course->image}}"  id="basic-icon-default-fullname"/>
                            </div>
                            <p style="margin-bottom: 2px;" class="text-danger error_container" id="error-image"></p>
                          </div>
                          @if($course->image!=NULL && file_exists(public_path('uploads/courses/'.$course->image)))
                              <div class="col-sm-6">
                                  <div class="form-group">
                                      <a href="{{asset('uploads/courses/'.$course->image)}}" target="_blank">
                                          <img src="{{asset('uploads/courses/'.$course->image)}}" width="100px" height="100px">
                                      </a>
                                  </div>
                              </div>
                          @endif
