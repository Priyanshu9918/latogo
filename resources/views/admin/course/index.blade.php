...
<style>
    ...
    left: 760px;
          ...
          <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                <!-- <a href="/admin/course/create" class="btn btn-primary btn-rounded cu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;"> Add Courses Banner</span></a> -->
                    <h4 class="card-title">Courses Banner</h4>
                    <div class="row">
                    <div class="col-12">
                        <table id="course-datatable" class="table">
...
<script>
    $(document).ready(function(){
        ...
        if ($("#course-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#course-datatable').DataTable({
                processing: true,
                serverSide: true,
            ...
            $("#course-datatable").parent().addClass('table-responsive');

            /*Select all using checkbox*/
            var  DT1 = $('#course-datatable').DataTable();
