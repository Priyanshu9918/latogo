...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                <a href="/admin/education_info/create" class="btn btn-primary btn-rounded bu d-none">
                    <i class="fa fa-plus-circle mr-1"></i>
                    <span style="bottom: 3px; position: relative;"> Add Education Info</span></a>
                    ...
                    $(document).ready(function() {
                        ...
                        if ($("#new-datatable").length > 0) {
                            ...
                            var targetDt = $('#new-datatable').DataTable({
                                processing: true,
                                serverSide: true,
                                ajax: "{{route('admin.education_info')}}",
