...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Manage Contact title</h4>
        ...
        <div class="row">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.contact_titles.create')}}" method="POST" id="createFrm" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.success == true) {
                                    //notify
                                    toastr.success("Contact Titles created Successfully");

                                    // Swal.fire({
                                    //     position: 'top-end',
                                    //     icon: 'success',
                                    //     title: 'Contact Titles Created Successfully',
