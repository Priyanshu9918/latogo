            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Add Referral Coupon</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('admin.referral.create')}}" method="POST" id="createFrm" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="number" class="form-control" name="referral" id="basic-icon-default-fullname" />
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                                        <input type="text" class="form-control" name="referral_coupon" id="basic-icon-default-fullname" />
                                    </div>
                            ...
                            {{--<div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                                        <input type="text" class="form-control" name="referring" id="basic-icon-default-fullname" />
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                                        <input type="text" class="form-control" name="referring_coupon" id="basic-icon-default-fullname" />
                                    </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.success == true) {
                                    //notify
                                    toastr.success("Referral Management created Successfully");

                                    // Swal.fire({
                                    //     position: 'top-end',
                                    //     icon: 'success',
                                    //     title: 'Referral Management Created Successfully',
