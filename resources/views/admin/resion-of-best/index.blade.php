            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                        <h4 class="card-title m-0">Resion Of Bests</h4>
                        <a href="/admin/resion/create" class="btn btn-primary btn-rounded cu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;"> Add Resion Of Best</span></a>
                    </div>

                    <div class="row">
                    <div class="col-12">
                        <table id="resion-datatable" class="table">
...
<script>
    $(document).ready(function(){
        ...
        if ($("#resion-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#resion-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route('admin.resion')}}",
            ...
            $("#resion-datatable").parent().addClass('table-responsive');

            /*Select all using checkbox*/
            var  DT1 = $('#resion-datatable').DataTable();
                        ...
                        if(e==true)
                        {
                            ...
                            $.ajax({
                                ...
                                success: function(data){
                                    ...
                                    if(data.code==200)
                                    {
                                        toastr.success("Resion of best deleted Successfully");
                                        window.setTimeout(function(){
                                            window.location.reload();
                                        },2000);
                                    }
