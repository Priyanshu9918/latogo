...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                <!-- <a href="/admin/transform_short_banners/create" class="btn btn-primary btn-rounded bu">
                    <i class="fa fa-plus-circle mr-1"></i>
                    <span style="bottom: 3px; position: relative;"> Transform Short Banner </span></a> -->
                <h4 class="card-title"> Transform Short Banner</h4>
                <div class="row">
                    <div class="col-12">
                        <table id="banner-datatable" class="table">
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        if ($("#banner-datatable").length > 0) {
                            /*Checkbox Add*/
                            var tdCnt = 0;
                            var targetDt = $('#banner-datatable').DataTable({
                                processing: true,
                                serverSide: true,
                                ajax: "{{route('admin.transform_short_banners')}}",
                            ...
                            $("#banner-datatable").parent().addClass('table-responsive');

                            /*Select all using checkbox*/
                            var DT1 = $('#banner-datatable').DataTable();
                        ...
                        $(document).on('click', '.statusBtn', function(event) {
                            ...
                            //  alert(user_id);
                            var table = 'transform_short_banners';
                            //alert('hello');
