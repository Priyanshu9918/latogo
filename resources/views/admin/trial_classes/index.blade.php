...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                <!-- <a href="/admin/trial_classes/create" class="btn btn-primary btn-rounded cu">
                    <i class="fa fa-plus-circle mr-1"></i>
                    <span style="bottom: 3px; position: relative;"> Add Trial classes</span></a> -->
                <h4 class="card-title">Trial Classes</h4>
                <div class="row">
                    <div class="col-12">
                        <table id="trial_classes-datatable" class="table">
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        if ($("#trial_classes-datatable").length > 0) {
                            /*Checkbox Add*/
                            var tdCnt = 0;
                            var targetDt = $('#trial_classes-datatable').DataTable({
                                processing: true,
                                serverSide: true,
                                ajax: "{{route('admin.trial_classes')}}",
                            ...
                            $("#trial_classes-datatable").parent().addClass('table-responsive');

                            /*Select all using checkbox*/
                            var DT1 = $('#trial_classes-datatable').DataTable();
