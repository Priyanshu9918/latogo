...
<style>
    ...
    left: 760px;
          ...
          <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                <!-- <a href="/admin/about/create" class="btn btn-primary btn-rounded cu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;"> Add About Us</span></a> -->
                    <h4 class="card-title">Abouts</h4>
                    <div class="row">
                    <div class="col-12">
                        <table id="about-datatable" class="table">
...
<script>
    $(document).ready(function(){
        ...
        if ($("#about-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#about-datatable').DataTable({
                processing: true,
                serverSide: true,
            ...
            $("#about-datatable").parent().addClass('table-responsive');

            /*Select all using checkbox*/
            var  DT1 = $('#about-datatable').DataTable();
