            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                        ...
                        <a href="/admin/blog/create" class="btn btn-primary btn-rounded cu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;"> Add Blogs</span></a>
                    </div>
                    <div class="row">
                    <div class="col-12">
                        <table id="blog-datatable" class="table">
...
<script>
    $(document).ready(function(){
        ...
        if ($("#blog-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#blog-datatable').DataTable({
                processing: true,
                serverSide: true,
            ...
            $("#blog-datatable").parent().addClass('table-responsive');

            /*Select all using checkbox*/
            var  DT1 = $('#blog-datatable').DataTable();
