        ...
        <div class="row">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.become_an_instructor_videos.edit',['id'=>base64_encode($become_an_instructor_videos->id)]) }}" method="POST" id="editFrm" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" class="form-control" name="title" id="basic-icon-default-fullname" value="{{$become_an_instructor_videos->title}}">
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                                        <input type="text" class="form-control" name="link" id="basic-icon-default-fullname" value="{{$become_an_instructor_videos->link}}">
                                    </div>
                                    <p style="margin-bottom: 2px;" class="text-danger error_container" id="error-title"></p>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                                        <textarea type="text" class="form-control" name="description" id="basic-icon-default-fullname">{{$become_an_instructor_videos->description}}</textarea>
                                    </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response.success == true) {
                                    ...
                                    //notify
                                    toastr.success("Become An Instructor Videos updated successfully");
                                    // Swal.fire({
                                    //     position: 'top-end',
                                    //     icon: 'success',
                                    //     title: 'Become An Instructor Videos Successfully',
                                    //     showConfirmButton: false,
                                    //     timer: 1500
                                    // })
                                    // redirect to google after 5 seconds
                                    window.setTimeout(function() {
                                        window.location = "{{ url('/')}}" + "/admin/become_an_instructor_videos";
                                    }, 2000);
