...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                <!-- <a href="/admin/become_an_instructor_videos/create" class="btn btn-primary btn-rounded bu">
                    <i class="fa fa-plus-circle mr-1"></i>
                    <span style="bottom: 3px; position: relative;">Add Video</span></a> -->
                    ...
                    $(document).ready(function() {
                        ...
                        if ($("#banner-datatable").length > 0) {
                            ...
                            var targetDt = $('#banner-datatable').DataTable({
                                processing: true,
                                serverSide: true,
                                ajax: "{{route('admin.become_an_instructor_videos')}}",
                        ...
                        $(document).on('click', '.statusBtn', function(event) {
                            ...
                            //  alert(user_id);
                            var table = 'become_an_instructor_videos';
                            //alert('hello');
