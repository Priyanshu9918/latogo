...
<style>
    ...
    left: 760px;
          ...
          <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                <!-- <a href="/admin/cms/create" class="btn btn-primary btn-rounded cu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;"> Add Cms</span></a> -->
...
<script>
    $(document).ready(function(){
        ...
        if ($("#cms-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#cms-datatable').DataTable({
                processing: true,
                serverSide: true,
            ...
            $("#cms-datatable").parent().addClass('table-responsive');

            /*Select all using checkbox*/
            var  DT1 = $('#cms-datatable').DataTable();
