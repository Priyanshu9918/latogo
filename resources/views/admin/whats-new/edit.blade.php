...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manage</span>What's new</h4>
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Edit What's new</h5>
                    </div>
                    <div class="card-body">
                    <form action="{{ route('admin.what-new.edit',['id'=>base64_encode($new->id)]) }}" method="POST" id="editFrm" enctype="multipart/form-data">
                            @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          @if($new->image!=NULL && file_exists(public_path('uploads/what-new/'.$new->image)))
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <a href="{{asset('uploads/what-new/'.$new->image)}}" target="_blank">
                                            <img src="{{asset('uploads/what-new/'.$new->image)}}" width="100px" height="100px">
                                        </a>
                                    </div>
                                </div>
                            @endif
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(response.success==true) {
                        ...
                        //notify
                        toastr.success("what's new updated Successfully");
                        // Swal.fire({
                        // position: 'top-end',
                        // icon: 'success',
                        // title: "what's new Updated Successfully",
                        // showConfirmButton: false,
                        // timer: 1500
                        // })
                        // redirect to google after 5 seconds
                        window.setTimeout(function() {
                            window.location = "{{ url('/')}}"+"/admin/what-new";
                        }, 2000);
