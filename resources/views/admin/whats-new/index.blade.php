...
<style>
    ...
    left: 780px;
          ...
          <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                <!-- <a href="/admin/what-new/create" class="btn btn-primary btn-rounded bu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;"> Add what's new</span></a> -->
