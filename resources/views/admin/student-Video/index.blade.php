            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                        <h4 class="card-title m-0">Videos</h4>
                        <a href="/admin/video/create" class="btn btn-primary btn-rounded cu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;"> Add Video</span></a>
                    </div>
                    <div class="row">
                    <div class="col-12">
                        <table id="video-datatable" class="table">
...
<script>
    $(document).ready(function(){
        ...
        if ($("#video-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#video-datatable').DataTable({
                processing: true,
                serverSide: true,
            ...
            $("#video-datatable").parent().addClass('table-responsive');

            /*Select all using checkbox*/
            var  DT1 = $('#video-datatable').DataTable();
