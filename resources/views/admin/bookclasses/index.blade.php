        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                    <h4 class="card-title m-0">Booking Classes</h4>
                    <a href="/admin/bookclasses/create" class="btn btn-primary btn-rounded cu">
                        <i class="fa fa-plus-circle mr-1"></i>
                         <span style="bottom: 3px; position: relative;"> Add Booking Classes</span></a>
                </div>
                <div class="row">
                    <div class="col-12">
                        <table id="new-datatable" class="table">
                            <thead style="background:#a0b8ed29;">
                                <tr>
                                    <th> #</th>
                                    <th><b>Youtube Url</b></th>
                                    <th><b>Teacher Name</b></th>
                                    <th><b>Teaches</b></th>
                                    <th><b>Student Enroll</b></th>
                                    <th><b>Lessons</b></th>
                                    <th><b>Action</b></th>
                                </tr>
                            </thead>
