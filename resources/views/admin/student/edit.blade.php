              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                    <form action="{{ route('admin.student.edit',['id'=>base64_encode($student->id)]) }}" method="POST" id="editFrm" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Full Name</label>
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              <input type="text" class="form-control" name="name" value="{{$student->name}}" id="basic-icon-default-name"/>
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              <input type="email" class="form-control" name="email" value="{{$student->email}}" id="basic-icon-default-email" readonly/>
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              <input type="number" class="form-control" name="phone" value="{{$student->phone}}" id="basic-icon-default-phone"/>
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="form-group form-group-merge position-relative">
                              <input type="password" class="form-control" id="password" name="password" value="{{$student->plan_password}}" id="basic-icon-default-password"/>
                ...
                success: function (response) {
                    ...
                    if(response.success==false ) {
                        for (control in response.errors) {
                           var error_text = control.replace('.',"_");readonly
