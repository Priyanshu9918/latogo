            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                        <h4 class="card-title m-0">Head Instructor</h4>
                        <a href="/admin/head/create" class="btn btn-primary btn-rounded cu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;"> Add Head Instructor</span></a>
                    </div>
                    <div class="row">
                    <div class="col-12">
                        <table id="inst-datatable" class="table">
...
<script>
    $(document).ready(function(){
        ...
        if ($("#inst-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#inst-datatable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route('admin.head')}}",
            ...
            $("#inst-datatable").parent().addClass('table-responsive');

            /*Select all using checkbox*/
            var  DT1 = $('#inst-datatable').DataTable();
