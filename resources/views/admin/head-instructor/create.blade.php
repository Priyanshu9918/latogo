                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Add Head Instructor</h5>
                    </div>
                    <div class="card-body">
                    <form action="{{route('admin.head.create')}}" method="POST" id="createFrm" enctype="multipart/form-data">
                            @csrf
                        <div class="row mb-3">
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(response.success==true) {
                        //notify
                        toastr.success("Head Instructor created Successfully");

                        // Swal.fire({
                        //     position: 'top-end',
                        //     icon: 'success',
                        //     title: 'Head Instructor Created Successfully',
