            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                        <h4 class="card-title m-0">Pricings</h4>
                        <a href="/admin/pricing/create" class="btn btn-primary btn-rounded cu">
                            <i class="fa fa-plus-circle mr-1"></i>
                             <span style="bottom: 3px; position: relative;"> Add Pricing</span></a>
                    </div>
                    <div class="row">
                    <div class="col-12">
                        <table id="p_master-datatable" class="table">
                        <thead style="background:#a0b8ed29;">
                            <tr>
                                <th> #</th>
                                <th><b>Price Master</b></th>
...
<script>
    $(document).ready(function(){
        ...
        if ($("#p_master-datatable").length > 0) {
            /*Checkbox Add*/
            var tdCnt=0;
            var targetDt = $('#p_master-datatable').DataTable({
                processing: true,
                serverSide: true,
                ...
                columns: [
                        ...
                        {data: 'price_master', name: 'price_master'},

                        {data: 'totle_class', name: 'totle_class'},
            ...
            $("#p_master-datatable").parent().addClass('table-responsive');

            /*Select all using checkbox*/
            var  DT1 = $('#p_master-datatable').DataTable();
