...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Manage Faq's</h4>
              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                    <form action="{{ route('admin.faq.edit',['id'=>base64_encode($faq->id)]) }}" method="POST" id="editFrm" enctype="multipart/form-data">
                            @csrf
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              ...
                              <input type="text" class="form-control" name="title" id="basic-icon-default-fullname" value="{{$faq->title}}">
                            </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                              <textarea type="text" class="form-control" name="short_description" id="basic-icon-default-fullname" value="{{$faq->short_description}}">{{$faq->short_description}}</textarea>
                            </div>
                        ...
                        <!-- <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"></span>
                              <input type="file" class="form-control" name="icon" id="basic-icon-default-fullname" value="{{$faq->icon}}"/>
                            </div>
                            <p style="margin-bottom: 2px;" class="text-danger error_container" id="error-icon"></p>
                          </div>
                          @if($faq->icon!=NULL && file_exists(public_path('uploads/faq/'.$faq->icon)))
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <a href="{{asset('uploads/faq/'.$faq->icon)}}" target="_blank">
                                            <img src="{{asset('uploads/faq/'.$faq->icon)}}" width="100px" height="100px">
                                        </a>
                                    </div>
                                </div>
                            @endif
