            ...
            <div class="container">
                ...
                <div class="main-menu-wrapper">
                    ...
                    <ul class="main-nav">
                        ...
                        <li class=" <?= ($activePage == 'course-structure') ? ' active':'' ?>">
                            <a href="{{url('course-structure')}}">All Courses </a>
                        </li>
                        <li class=" <?= ($activePage == 'view') ? ' active':'' ?>">
                        ...
                        <li style="line-height: 70px;">
                            ...
                            <!-- <div class="dsdropdown " style="background: #fff;line-height: 15px;margin-top: 15px;position: relative;">
