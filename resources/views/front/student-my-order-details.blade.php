                            ...
                            <div class="card instructor-card w-100">
                                ...
                                <div class="card-body align-items-center justify-content-center d-flex">
                                    <div>
                                        ...
                                        <a><img style="width: 90px;padding-right: 10px;" src="{{asset('uploads/user/avatar/'.$student1->avtar)}}" alt="" class="img-fluid"></a>
                                        @else
                                        <img style="width: 90px;padding-right: 10px;" src="{{asset('assets/user.jpg')}}" alt="" class="img-fluid">
                                        @endif
                                    </div>
                                            ...
                                            <div class="settings-inner-blk p-0">
                                                ...
                                                <div class="comman-space pb-0">
                                                    <div class="settings-tickets-blk course-instruct-blk table-responsive">
                                                        <?php
                                                        $order_item = DB::table('order_items')->select(DB::raw('SUM(quantity) as total_item'))->where('order_id', $order_details_data->id)->first();
                                                        $order_item1 = DB::table('order_items')->where('order_id', $order_details_data->id)->first();
                                                        ...
                                                        <table class="table table-nowrap mb-0">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <?php $order_item1 = DB::table('order_items')->where('order_id', $order_details_data->id)->get();
                                                                    ?>
                                                                    <?php $sub_total = 0; ?>
                                                                    ...
                                                                    <td>{{ isset($courses->title)?$courses->title:'' }} / {{ isset($priceval->time)?$priceval->time:'' }} min/ {{ isset($priceval->totle_class)?$priceval->totle_class:'' }}x Classes</td>
                                                                    <td>$ {{ isset($order_items1->price)?$order_items1->price:'' }}</td>
                                                                    <?php $sub_total = $sub_total + ($order_items1->price); ?>
                                                                </tr>
                                                                @endforeach
                                                                <tr>
                                                                    <th>Subtotal</th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $order_details_data->payment_method }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th clas="fw-bold">Total</th>
                                                                    <td>$ {{ $sub_total }}.00</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <div class="card" style="width: 18rem;">
                                                            <div class="card-body">
                                                                <h5 class="card-title fw-bold">Billing address</h5>
                                                                <?php
                                                                $address = DB::table('billing_details')->where('user_id', $order_details_data->user_id)->first();
                                                                ?>
