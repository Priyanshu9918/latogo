			...
			<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
				...
				<tr style="background: #fff;">
					<td  >
						...
						<tr>
							<img src="{{ asset('assets/img/new-website-launch-latogo.jpg') }}" alt="" style="width:100%;height:auto;">
						</tr><!-- end: tr -->
						</table>
					</td>
				</tr>
							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										<p style="font-weight: 500;"><b>Dear {{ $name }},</b></p>

										<p>We have thrilling news for you! Latogo.de has launched a brand-new website, offering enhanced features and an improved learning experience.</p>
										
										<p><strong>Here's what you need to know:</strong></p>
										<p><b>Login Details:</b></p>
										<p>Simply go to www.latogo.de and log in with your existing username and password.</p>
										
										<p><b>Enhanced Features:</b></p>
										<p>Enjoy an improved class booking system, interactive practice section, smart classroom with MP4 recordings, downloadable materials, flexible scheduling, and a team of dedicated teachers. </p>
										<img src="{{ asset('assets/img/new-website-launch-latogo-2.jpg') }}" style="width:100%;" />
										
										<p><b>Referral Program:</b></p>
										<p>We're excited to introduce our referral program! Invite your friends to learn German with Latogo.de, and both you and your friends will receive rewards. Share your <b>unique referral link</b> (Login - Dashboard - Profile - Refer a friend) and start spreading the joy of language learning together!</p>
										
										<p>We're here to support your language learning journey every step of the way. Log in now to explore the exciting updates and unlock your path to fluency.</p>

										<p>Thank you for being a valued student at Latogo.de. Together, let's embark on this new chapter of learning success!</p>
									...
									<table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
										<tr>
											<td  style="text-align: center;font-size: 12px;line-height: 15px;font-weight: 600;">
												<a href="https://www.latogo.de/support" target="_blank" style="color:#00000099;flex-basis: 50%;text-align: end;">
													<small>
														Contact Us
													</small>
												</a>
