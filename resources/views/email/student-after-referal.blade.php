							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										...
										<p>We're excited to have you on board and can't wait to get you started on your learning journey.</p>
											
										<p>Here's the scoop: As a thank-you for registering via a referral link, we're offering you a 45-minute trial class for just $5! 🌟</p>
										
                                        <p>How to book a Trial Class? </p>
										<ul>
											<li style="margin: 10px 0px;"> <span>1 </span>Step: Visit Our Website</li>
											<li style="margin: 10px 0px;"> <span>2 </span>step: Log In</li>
											<p>
												<!-- <a href="{{url('/student/checkoutNew')}}"><button style=" padding: 10px 20px; border: none; border-radius: 7px; color: #fff; background-color: #009fff; font-size: 16px; font-weight: 500;">Book Now</button></a> -->
												<a href="{{url('/student/my-classes')}}"><button style=" padding: 10px 20px; border: none; border-radius: 7px; color: #fff; background-color: #009fff; font-size: 16px; font-weight: 500;">Book Now</button></a>
											</p>
                                            <p>With your credit now active, you can instantly schedule your very first class.</p>
										</ul>
										
                                        <p>Ready to dive into learning? </p>
										
											<p>If you have any questions or need assistance with the referral process, our support team is here to help. Reach out to us at <a href="mailto:support@latogo.de" style="color:#f6697b;text-decoration: none;">support@latogo.de</a>and we'll be glad to assist you.</p>
											<p>Start your German language journey today with Latogo! We can't wait to see you thrive and succeed in mastering this beautiful language.</p>
