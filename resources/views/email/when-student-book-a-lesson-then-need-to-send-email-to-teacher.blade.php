			...
			<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
				...
				<tr style="background: #fff;">
					<td  >
						...
						<tr>
							<img src="{{ asset('base-url/assets/img/email/class-confirmation.webp') }}" alt="" style="width:100%;height:auto;">
						</tr><!-- end: tr -->
						</table>
					</td>
				</tr>
							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										...
										<p>Congratulations!🎉 You have a new lesson booking on Latogo. We're thrilled to connect you with another eager student who is ready to learn and grow under your guidance. Here are the important details for the upcoming lesson:</p>

										<div>
											<p><b>Student :</b> <code>{{ $s_name }}</code></p>
										...
										<p>Please prepare for the lesson and ensure you're ready to provide a fantastic learning experience. We encourage you to review the student's profile and any specific requests or preferences they may have mentioned.</p>

										<p>During the lesson, aim to create an engaging and supportive environment that promotes active participation and fosters the student's language development. Feel free to leverage the resources available on Latogo to enhance the learning experience.</p>

										<p>If you have any concerns or need to communicate with the student prior to the lesson, you can reach out to them directly through the messaging feature on your Latogo teacher dashboard</p>

											<p>We wish you a productive and successful lesson with your student. Thank you for being an essential part of Latogo's language-learning journey.</p>
