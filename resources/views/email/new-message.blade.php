							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										...
										<p>You received new message(s) on Latogo. You can view your messages in the Message Center by clicking below.</p>
										@if(Auth::user() && Auth::user()->user_type == 1)
										<p><a style="color: #fff;border: 3px solid #f6697b;border-radius: 46.9159px;background: #f6697b;border-radius: 46.9159px;min-width: 150px;padding: 4px 15px;text-align: center;font-weight: 500;text-decoration: dashed;display: block;margin: auto;max-width: 190px;" href="{{url('/chatify')}}">View Unread Messages</a></p>
										@endif
										@if(Auth::user() && Auth::user()->user_type == 2)
										<p><a style="color: #fff;border: 3px solid #f6697b;border-radius: 46.9159px;background: #f6697b;border-radius: 46.9159px;min-width: 150px;padding: 4px 15px;text-align: center;font-weight: 500;text-decoration: dashed;display: block;margin: auto;max-width: 190px;" href="{{url('/chatify')}}">View Unread Messages</a></p>
										@endif
										<p style="font-weight:600;">Best wishes,<br>
										The Latogo Team</p>
										</p>
										</div>
								</td>
