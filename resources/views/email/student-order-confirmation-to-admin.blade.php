							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										<p style="font-weight: 500;"><b>Dear Admin,</b></p>
										{{-- <p>Congratulations on your recent purchase of 
											<b>
												<code>@foreach($package_name as $pack_name){{$pack_name}} @endforeach</code>
											</b> 
											from Latogo! Get ready to accelerate your German language skills and embark on an exciting learning journey.
										</p> --}}

										<p>Information about a new purchase that was made on Latogo.de</p>
											
										<h4>Package Details:</h4>
										<div>
											<p><b>Package ID :</b> <code>{{$order_no}}</code></p>
											<p><b>Package Name :</b> <code>@foreach($package_name as $pack_name){{$pack_name}}@endforeach</code></p>
											<p><b>Purchase Date :  </b><code>{{date('m-d-Y', strtotime($created_at))}}</code></p>
											<p><b>Customer Name: </b><code>{{ $sender_name }}</code></p>
										</div>
											
										<p>TThank you for your attention to this matter.</p>										
