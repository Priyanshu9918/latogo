			...
			<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
				...
				<tr style="background: #fff;">
					<td  >
						...
						<tr>
							<img src="{{asset('base-url/assets/img/email/order-confirmation.webp')}}" alt="" style="width:100%;height:auto;">
						</tr><!-- end: tr -->
						</table>
					</td>
				</tr>
							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										...
										<p>Congratulations on your recent purchase of <b><code>@foreach($package_name as $pack_name){{$pack_name}} @endforeach</code></b> from Latogo! Get ready to accelerate your German language skills and embark on an exciting learning journey.</p>
											
										<h4>Package Details:</h4>
										<div>
											<p><b>Package ID :</b> <code>{{$order_no}}</code></p>
											<p><b>Start Date :  </b><code>{{date('m-d-Y', strtotime($created_at))}}</code></p>
											<p><b>Expiration Date: </b><code>{{date('m-d-y', strtotime("+3 months", strtotime($created_at)))}}</code></p>
										</div>
											
										<p>To access your package and begin learning, simply log in to your Latogo account. Navigate to the <b>"Live Classes"</b> section, where you'll find our teachers and availabilities.</p>
										
										<p>We're thrilled to let you know that Latogo credits are now available in your profile. These credits can be used to book live classes with our experienced instructors. Take advantage of this opportunity to receive personalized guidance and support tailored to your needs.</p>
										
										<p>Click the button below to book your first class now!</p>

										<p><a style="color: #fff;border: 3px solid #f6697b;border-radius: 46.9159px;background:#f6697b;border-radius: 46.9159px;min-width: 150px;padding: 0px 15px;font-weight: 500;text-decoration: none;" href="{{url('/student/student-book-a-class')}}">Book your Class</a></p>
										
											<p>If you have any questions or need assistance during your learning journey, our support team is here to help. Feel free to reach out to us at <a href="mailto:support@latogo.de" style="color:#f6697b;">support@latogo.de</a>. </p>
											<p>Thank you for choosing Latogo as your language-learning platform. We're excited to be a part of your progress and look forward to witnessing your success as you master the German language.</p>
