							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										<p style="font-weight: 500;"><b>Dear {{$t_name}},</b></p>

										<p>We hope this email finds you well. We wanted to inform you that one of your scheduled classes has been canceled by the student. Please find below the details of the canceled class:</p>
										<p>As a Latogo teacher, you'll have the opportunity to inspire and empower students from around the world in their language-learning endeavors. We're confident that your expertise and passion for teaching will make a significant impact on our students' language acquisition.</p>

										<h4>Class Details:</h4>
										<div>
											<p><b>Date :</b> <code>{{$class_date}}</code></p>
											<p><b>Name :  </b><code>{{$class_name}}</code></p>
											<p><b>Time : </b><code>{{$class_time}}</code></p>
										</div>
                                        <p>We understand that schedule changes can occur, and we wanted to keep you informed about this cancellation.</p>
                                        <p>If you have any questions or require further assistance regarding this matter or any other class-related inquiries, please don't hesitate to reach out to our support team at <a href="mailto:support@latogo.de" style="color:#f6697b;text-decoration: none;">support@latogo.de</a>. We are here to assist you.</p>
										
                                        <p>Thank you for your understanding and flexibility. Your dedication to providing quality education is greatly appreciated.</p>
                                        
                                        <p style="font-weight:600;">Best regards,<br>
										The Latogo Team</p>
										</p><table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
										<tr>
