							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										...
										<p>Just a quick reminder that your Latogo class is scheduled to start in just 30 minutes. We hope you're ready for an engaging and productive session!</p>
										...
										<p><a style="color: #fff;border: 3px solid #f6697b;border-radius: 46.9159px;background:#f6697b;border-radius: 46.9159px;min-width: 150px;padding: 0px 15px;font-weight: 500;text-decoration: none;" href="#">Join Class</a></p>
