			...
			<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
				...
				<tr style="background: #fff;">
					<td  >
						...
						<tr>
							<img src="{{asset('base-url/assets/img/email/welcome.webp')}}" alt="" style="width:100%;height:auto;">
						</tr><!-- end: tr -->
						</table> 
					</td>
				</tr>
							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										<p style="font-weight: 500;"><b>Hey </b></p>

										<p>I hope you're doing great! I have some exciting news for you. You've been personally invited from your friend <code>{{$sender_name}}</code> to join our immersive German trial class at Latogo! As a special offer, you can get a 45-minute class for only $5</p>

										<p>But that's not all - by accepting this invitation, not only you but also your friend will benefit. It's a win-win situation!</p>

										<p>Here's how to claim your trial class and start your German language journey:</p>
										<div>
											<p>1 . Click the link below to visit our registration page.</p>
											<p>2 . Sign up and create your Latogo account.</p>
											<p>3 . Purchase the trial class package for just $5.</p>
											<p>4 . Enjoy your 45-minute language class with our.</p>
										</div>
										<p>amazing teachers!</p>

										<P><code>{{$referal}}</code></P>

										<p>Learning a new language opens doors to incredible opportunities and expands your horizons. With our innovative teaching methods and dedicated teachers, you'll be well on your way to mastering German.
											Don't miss out on this exclusive offer to kickstart your language learning journey. Join our vibrant community of learners at Latogo today!</p>

										<p>If you have any questions or need assistance, feel free to reach out to our friendly support team at support@latogo.de. We're here to help you every step of the way.</p>
										
										<p>I can't wait to see you thrive and explore the fascinating world of German language and culture.</p>
