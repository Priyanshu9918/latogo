							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										<p style="font-weight: 500;"><b>Dear {{$s_name}},</b></p>

										<p>We regret to inform you that your upcoming class scheduled for [{{$class_date}}, {{$class_name}}, and {{$class_time}}] has been cancelled by your teacher. We sincerely apologize for any inconvenience this may cause.</p>
										<p>Please note the following details regarding the cancellation:</p>
										...
										<div>
											...
											<p><b>Refund : </b><code>1 Credit</code></p>
										</div>
										<p>You will automatically receive a full refund for the cancelled class.</p>
										<p>We understand that this disruption to your learning plans may be disappointing, and we apologize for any inconvenience caused. Our team is working diligently to ensure that such cancellations are minimized in the future.</p>										
										<p>If you have any questions or concerns regarding this cancellation or any other matter, please don't hesitate to reach out to our support team at <a href="mailto:support@latogo.de" style="color:#f6697b;text-decoration: none;">support@latogo.de</a>. We are here to assist you.</p>
                                        <p>We appreciate your understanding and look forward to continuing to support your learning journey at Latogo.</p>
