			...
			<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
				...
				<tr style="background: #fff;">
					<td  >
						...
						<tr>
							<img src="{{asset('base-url/assets/img/email/thank-you.webp')}}" alt="" style="width:100%;height:auto;">
						</tr><!-- end: tr -->
						</table>
					</td>
				</tr>
							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										<p style="font-weight: 500;"><b>Hi {{$sender_name}},</b></p>

										<p>Congratulations on your successful referral! We're thrilled to inform you that you've earned a credit for a free class for spreading the word about Latogo.</p>

										<p>Your friend, <code>{{$friend_name}}</code>, has joined Latogo using your unique referral code and completed their first purchase or class booking. We truly appreciate your support in expanding our language-learning community.</p>

										<p>To redeem your free class, simply follow the steps below:</p>
										
										<ul>
											<li style="margin: 10px 0px;">Log in to your Latogo account using your registered email address and password.</li>
											<li style="margin: 10px 0px;">Navigate to the <b>"Prices"</b> section, where you'll find our packages</li>
											<li style="margin: 10px 0px;">This coupon code entitles you to a 1 x 45-minute class with one of our experienced language instructors.</li>
											<li style="margin: 10px 0px;">When booking a class, enter the following coupon code: <code style="color:#f6697b;" >{{$coupan_code}}</code></li>
										</ul>

										<p>If you have any questions or need assistance with redeeming your credit or booking your free class, please don't hesitate to reach out to our support team at <a href="mailto:support@latogo.de" style="color:#f6697b;text-decoration: none;">support@latogo.de</a>. We're here to ensure a seamless experience for you.</p>

										<p>Congratulations again on your referral success! We look forward to supporting you in reaching your language goals.</p>
