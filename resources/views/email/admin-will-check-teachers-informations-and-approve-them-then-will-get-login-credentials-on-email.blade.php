							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										...
										<p>We're pleased to inform you that your teacher account on Latogo has been approved and activated! Welcome aboard as an official Latogo language teacher. We're thrilled to have you join our platform and share your expertise with our students.</p>

										<p>To access your teacher account, please find your login credentials below:</p>

										<div>
											<p><b>Username :</b> <code>{{$sender_email}}</code></p>
											<p><b>Password :  </b><code>{{$password}}</code></p>
										</div>

										<p>Please keep your login information secure and refrain from sharing it with anyone. These credentials will allow you to log in to your Latogo teacher dashboard, where you can manage your classes, connect with students, and shape their language-learning experiences.</p>

										<p>We recommend taking a few moments to explore the various features and tools available to you. Customize your profile, set your availability, and familiarize yourself with the resources and support materials designed to help you succeed as a Latogo teacher.</p>
										
										<p>If you have any questions, encounter any technical issues, or need assistance with any aspect of your teacher account, please don't hesitate to contact our support team at <a href="mailto:support@latogo.de" style="color:#f6697b;text-decoration: none;">support@latogo.de</a>.  We're here to provide guidance and support every step of the way.</p>
										
										<p>We wish you all the best in your teaching endeavors on Latogo!</p>
