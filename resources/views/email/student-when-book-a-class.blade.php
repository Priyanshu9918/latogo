							...
							<tr>
								<td style="padding: 2.5em;background-color: #fff;">
									<div  style="padding: 0 20px;font-family: Verdana, Geneva, sans-serif;color:#4c4c4c;    font-size: 18px;">
										...
										<p>We're excited to confirm your upcoming German language class booking at Latogo! Get ready for an immersive learning experience that will elevate your language skills.</p>

										<h4>Class Details:</h4>
										<div>
											<p><b>Date :</b> <code>{{ date('d M Y',strtotime($class_time)) }}</code></p>
											<p><b>Time :  </b><code>{{ date('h:i A',strtotime($class_time)) }} according to the student's time zone</code></p>
											<p><b>Duration : </b><code>{{ $class_durection }}</code></p>
										</div>

										<p>Please mark your calendar and ensure you're available at the scheduled class time. Our dedicated instructor will guide you through an engaging and interactive lesson designed to enhance your German proficiency.</p>

										<p>If you need to reschedule or cancel the class, kindly inform us at least 24 hours in advance. For more details, please review our class <a href="http://latogo.techsaga.live/student/cancle" target="_blank" style="color:#f6697b;text-decoration: none;">cancellation policy </a></p>

										<p>We're excited to have you join us for this class and can't wait to see your growth in the German language.</p>

											<p>If you have any questions, please reach out to our support team at <a href="mailto:support@latogo.de" style="color:#f6697b;text-decoration: none;">support@latogo.de</a>. We're here to support you on your language learning journey.</p>
