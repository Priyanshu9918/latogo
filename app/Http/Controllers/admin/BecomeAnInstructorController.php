...
class BecomeAnInstructorController  extends Controller
{
    //
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('become_an_instructors')->where('status','<>',2)->OrderBy('created_at','DESC')->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/become_an_instructors/edit',['id'=>base64_encode($row->id)]);
        ...
        return view('admin.become_an_instructors.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        {
            return view('admin.become_an_instructors.create');
        }
        ...
        try{
            ...
            if($request->file('image')){
                ...
                $destination_path = public_path('/uploads/become_an_instructors/');
            ...
            DB::table('become_an_instructors')->insert($data);
            DB::commit();
            return response()->json([
                'success' =>true
            ]);
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $become_an_instructors = DB::table('become_an_instructors')->where('id',$customer_id)->first();

            return view('admin.become_an_instructors.edit',compact('become_an_instructors'));
        }
        ...
        $about = DB::table('become_an_instructors')->where('id',$customer_id)->first();
        ...
        try{
            ...
            DB::table('become_an_instructors')->where('id',$customer_id)->update($data);
