...
class PriceMasterController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('price_masters')->where('status','<>',2)->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/price-master/edit',['id'=>base64_encode($row->id)]);
        ...
        return view('admin.price-master.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        {
            return view('admin.price-master.create');
        ...
        try{
            ...
            if($request->file('icon')){
                ...
                $destination_path = public_path('/uploads/price/');
            ...
            DB::table('price_masters')->insert($data);
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $price = DB::table('price_masters')->where('id',$customer_id)->first();

            return view('admin.price-master.edit',compact('price'));
        }
        ...
        try{
            ...
            DB::table('price_masters')->where('id',$customer_id)->update($data);
