...
class TransformShortBannerController  extends Controller
{
    //
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('transform_short_banners')->where('status','<>',2)->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/transform_short_banners/edit',['id'=>base64_encode($row->id)]);
        ...
        return view('admin.transform_short_banners.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        {
            return view('admin.transform_short_banners.create');
        }
        ...
        try{
            ...
            if($request->file('image')){
                ...
                $destination_path = public_path('/uploads/transform_short_banners/');
            ...
            DB::table('transform_short_banners')->insert($data);
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $transform_short_banners = DB::table('transform_short_banners')->where('id',$customer_id)->first();

            return view('admin.transform_short_banners.edit',compact('transform_short_banners'));
        }
        ...
        $about = DB::table('transform_short_banners')->where('id',$customer_id)->first();
        ...
        try{
            ...
            DB::table('transform_short_banners')->where('id',$customer_id)->update($data);
