...
class BannerController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('banners')->where('status','<>',2)->get();
    ...
    public function create(Request $request)
    {
        ...
        $rules = [
            ...
            'count_complete_lession' => 'required',
        ...
        try{
            ...
            $data = [
                ...
                'count_complete_lession' => $request->input('count_complete_lession'),
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $banner = DB::table('banners')->where('id',$customer_id)->first();
        ...
        $about = DB::table('banners')->where('id',$customer_id)->first();
        ...
        try{
            ...
            {
                $final_image_name = $about->banner_image;
            }
            ...
            DB::table('banners')->where('id',$customer_id)->update($data);
