...
class WhyWeController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('why_wes')->where('status','<>',2)->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/why-we/edit',['id'=>base64_encode($row->id)]);
        ...
        return view('admin.why-we.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        try{
            ...
            if($request->file('icon')){
                ...
                $destination_path = public_path('/uploads/why-we/');
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $why = DB::table('why_wes')->where('id',$customer_id)->first();

            return view('admin.why-we.edit',compact('why'));
        }
        ...
        $about = DB::table('why_wes')->where('id',$customer_id)->first();
        ...
        try{
            ...
            DB::table('why_wes')->where('id',$customer_id)->update($data);
