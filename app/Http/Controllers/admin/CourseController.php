...
class CourseController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            $blog = DB::table('courses')->where('status','<>',2)->get();
            // dd(1);
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/course/edit',['id'=>base64_encode($row->id)]);
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $course = DB::table('courses')->where('id',$category_id)->first();
        ...
        try{
            ...
            $blog = DB::table('courses')->where('id',$category_id)->first();
            ...
            DB::table('courses')->where('id',$category_id)->update($data);
