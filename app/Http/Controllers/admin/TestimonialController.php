...
class TestimonialController  extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('testimonials')->where('status','<>',2)->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/testimonials/edit',['id'=>base64_encode($row->id)]);
    ...
    public function create(Request $request)
    {
        ...
        try{
            ...
            if($request->file('image')){
                ...
                $destination_path = public_path('/uploads/testimonials/');
            ...
            $data = [
                ...
                'designation' => $request->input('country'),
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $testimonials = DB::table('testimonials')->where('id',$customer_id)->first();
        ...
        $about = DB::table('testimonials')->where('id',$customer_id)->first();
        ...
        try{
            ...
            DB::table('testimonials')->where('id',$customer_id)->update($data);
