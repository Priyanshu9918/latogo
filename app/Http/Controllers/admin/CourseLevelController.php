...
class CourseLevelController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('course_levels')->where('status','<>',2)->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/course_level/edit',['id'=>base64_encode($row->id)]);
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $level = DB::table('course_levels')->where('id',$customer_id)->first();
        ...
        $about = DB::table('course_levels')->where('id',$customer_id)->first();
        ...
        try{
            ...
            DB::table('course_levels')->where('id',$customer_id)->update($data);
