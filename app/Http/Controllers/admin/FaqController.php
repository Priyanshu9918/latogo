...
class FaqController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('faqs')->where('status','<>',2)->get();
    ...
    public function create(Request $request)
    {
        ...
        try{
            ...
            if($request->file('icon')){
                ...
                $destination_path = public_path('/uploads/faq/');
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $faq = DB::table('faqs')->where('id',$customer_id)->first();
        ...
        $about = DB::table('faqs')->where('id',$customer_id)->first();
        ...
        try{
            ...
            DB::table('faqs')->where('id',$customer_id)->update($data);
