...
class StudenLoginPageController extends Controller
{
    //
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $user = DB::table('studentlogins')->where('status', '<>', 2)->get();
            ...
            $datatables = Datatables::of($user)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $edit_url = url('/admin/student_login/edit', ['id' => base64_encode($row->id)]);
        ...
        return view('admin.student_login.index');
    }

    public function create(Request $request)
    {
        if ($request->isMethod('get')) {
            return view('admin.student_login.create');
        ...
        try {
            ...
            if ($request->file('image')) {
                ...
                $destination_path = public_path('/uploads/student_login/');
            ...
            DB::table('studentlogins')->insert($data);
    ...
    public function edit(Request $request)
    {
        ...
        if ($request->isMethod('get')) {
            $new = DB::table('studentlogins')->where('id', $customer_id)->first();

            return view('admin.student_login.edit', compact('new'));
        }
        ...
        $about = DB::table('studentlogins')->where('id', $customer_id)->first();
        ...
        try {
            ...
            DB::table('studentlogins')->where('id', $customer_id)->update($data);
