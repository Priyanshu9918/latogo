...
class WhatsnewpointController extends Controller
{
    //
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('whatnewpoints')->where('status','<>',2)->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/whats-new-point/edit',['id'=>base64_encode($row->id)]);
        ...
        return view('admin.whats-new-point.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        {
            return view('admin.whats-new-point.create');
        }
        ...
        try{
            ...
            if($request->file('image')){
                ...
                $destination_path = public_path('/uploads/whats-new-point/');
            ...
            DB::table('whatnewpoints')->insert($data);
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $new = DB::table('whatnewpoints')->where('id',$customer_id)->first();

            return view('admin.whats-new-point.edit',compact('new'));
        }
        ...
        $about = DB::table('whatnewpoints')->where('id',$customer_id)->first();
        ...
        try{
            ...
            DB::table('whatnewpoints')->where('id',$customer_id)->update($data);
