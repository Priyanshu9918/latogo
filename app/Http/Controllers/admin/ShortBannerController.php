...
class ShortBannerController  extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $user = DB::table('short_banners')->where('status', '<>', 2)->get();
            ...
            $datatables = Datatables::of($user)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $edit_url = url('/admin/short_banners/edit', ['id' => base64_encode($row->id)]);
        ...
        return view('admin.short_banners.index');
    }

    public function create(Request $request)
    {
        if ($request->isMethod('get')) {
            return view('admin.short_banners.create');
        }
        ...
        try {
            ...
            if ($request->file('image')) {
                ...
                $destination_path = public_path('/uploads/short_banners/');
            ...
            DB::table('short_banners')->insert($data);
    ...
    public function edit(Request $request)
    {
        ...
        if ($request->isMethod('get')) {
            $short_banners = DB::table('short_banners')->where('id', $customer_id)->first();

            return view('admin.short_banners.edit', compact('short_banners'));
        }
        ...
        $about = DB::table('short_banners')->where('id', $customer_id)->first();
        ...
        try {
            ...
            DB::table('short_banners')->where('id', $customer_id)->update($data);
