...
class HeadInstructorController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('head_instructors')->where('status','<>',2)->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/head/edit',['id'=>base64_encode($row->id)]);
        ...
        return view('admin.head-instructor.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        {
            return view('admin.head-instructor.create');
        ...
        try{
            ...
            if($request->file('image')){
                ...
                $destination_path = public_path('/uploads/head/');
            ...
            DB::table('head_instructors')->insert($data);
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $head = DB::table('head_instructors')->where('id',$customer_id)->first();

            return view('admin.head-instructor.edit',compact('head'));
        }
        ...
        $about = DB::table('head_instructors')->where('id',$customer_id)->first();
        ...
        try{
            ...
            DB::table('head_instructors')->where('id',$customer_id)->update($data);
