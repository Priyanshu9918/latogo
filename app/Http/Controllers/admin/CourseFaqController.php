...
class CourseFaqController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('course_faqs')->where('status','<>',2)->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/course_faq/edit',['id'=>base64_encode($row->id)]);
        ...
        return view('admin.course-faq.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        {
            return view('admin.course-faq.create');
        ...
        try{
            ...
            DB::table('course_faqs')->insert($data);
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $course_faq = DB::table('course_faqs')->where('id',$customer_id)->first();

            return view('admin.course-faq.edit',compact('course_faq'));
        }
        ...
        try{
            ...
            DB::table('course_faqs')->where('id',$customer_id)->update($data);
