...
class ClientController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('clients')->where('status','<>',2)->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/client/edit',['id'=>base64_encode($row->id)]);
    ...
    public function create(Request $request)
    {
        ...
        try{
            ...
            if($request->file('image')){
                ...
                $destination_path = public_path('/uploads/client/');
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $new = DB::table('clients')->where('id',$customer_id)->first();

            return view('admin.client.edit',compact('new'));
        }
        ...
        $about = DB::table('clients')->where('id',$customer_id)->first();
        ...
        try{
            ...
            DB::table('clients')->where('id',$customer_id)->update($data);
