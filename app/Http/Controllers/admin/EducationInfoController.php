...
class EducationInfoController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $user = DB::table('education_infos')->where('status', '<>', 2)->get();
            ...
            $datatables = Datatables::of($user)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $edit_url = url('/admin/education_info/edit', ['id' => base64_encode($row->id)]);
                    ...
                    $action_3 = '<a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover deleteBtn d-none"
                                data-bs-toggle="tooltip" data-placement="top" title=""
        ...
        return view('admin.education_info.index');
    }

    public function create(Request $request)
    {
        if ($request->isMethod('get')) {
            return view('admin.education_info.create');
        ...
        try {
            ...
            if ($request->file('image')) {
                ...
                $destination_path = public_path('/uploads/education_info/');
    ...
    public function edit(Request $request)
    {
        ...
        if ($request->isMethod('get')) {
            $education_info = DB::table('education_infos')->where('id', $customer_id)->first();

            return view('admin.education_info.edit', compact('education_info'));
        }
        ...
        $about = DB::table('education_infos')->where('id', $customer_id)->first();
        ...
        try {
            ...
            DB::table('education_infos')->where('id', $customer_id)->update($data);
