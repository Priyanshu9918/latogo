...
class FooterTextController  extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $user = DB::table('footer_texts')->where('status', '<>', 2)->get();
            ...
            $datatables = Datatables::of($user)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $edit_url = url('/admin/footer_texts/edit', ['id' => base64_encode($row->id)]);
        ...
        return view('admin.footer_texts.index');
    }

    public function create(Request $request)
    {
        if ($request->isMethod('get')) {
            return view('admin.footer_texts.create');
        }
        ...
        try {
            ...
            DB::table('footer_texts')->insert($data);
    ...
    public function edit(Request $request)
    {
        ...
        if ($request->isMethod('get')) {
            $footer_texts = DB::table('footer_texts')->where('id', $customer_id)->first();

            return view('admin.footer_texts.edit', compact('footer_texts'));
        }
        ...
        $about = DB::table('footer_texts')->where('id', $customer_id)->first();
        ...
        try {
            ...
            DB::table('footer_texts')->where('id', $customer_id)->update($data);
