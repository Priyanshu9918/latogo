...
class ResionOfBestController extends Controller
{
    //
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('resion_of_bests')->where('status','<>',2)->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/resion/edit',['id'=>base64_encode($row->id)]);
        ...
        return view('admin.resion-of-best.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        {
            return view('admin.resion-of-best.create');
            // return view('admin.user.create');
        }

        $rules = [
            'title' => 'required|min:1|max:255',
            'short_title' => 'required|min:1|max:255',
            'icon' => 'required|mimes:jpeg,jpg,bmp,png,gif,svg',
        ];
        $custom = [
            'icon.required' => 'The image field is requires.',
        ];
        ...
        try{
            ...
            if($request->file('icon')){
                ...
                $destination_path = public_path('/uploads/resion/');
            ...
            DB::table('resion_of_bests')->insert($data);
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $resion = DB::table('resion_of_bests')->where('id',$customer_id)->first();

            return view('admin.resion-of-best.edit',compact('resion'));
        }
        ...
        $about = DB::table('resion_of_bests')->where('id',$customer_id)->first();
        ...
        try{
            ...
            DB::table('resion_of_bests')->where('id',$customer_id)->update($data);
