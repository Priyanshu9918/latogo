...
class BecomeAnInstructorVideoController  extends Controller
{
    //
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('become_an_instructor_videos')->where('status','<>',2)->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/become_an_instructor_videos/edit',['id'=>base64_encode($row->id)]);
        ...
        return view('admin.become_an_instructor_videos.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        {
            return view('admin.become_an_instructor_videos.create');
        }
        ...
        try{
            ...
            DB::table('become_an_instructor_videos')->insert($data);
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $become_an_instructor_videos = DB::table('become_an_instructor_videos')->where('id',$customer_id)->first();

            return view('admin.become_an_instructor_videos.edit',compact('become_an_instructor_videos'));
        }
        ...
        $about = DB::table('become_an_instructor_videos')->where('id',$customer_id)->first();
        ...
        try{
            ...
            DB::table('become_an_instructor_videos')->where('id',$customer_id)->update($data);
