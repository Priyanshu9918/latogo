...
class ContactTitleController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->ajax())
        {
            ...
            $user = DB::table('contact_titles')->where('status','<>',2)->get();
            ...
            ->addColumn('action', function($row) {
                ...
                $edit_url = url('/admin/contact_titles/edit',['id'=>base64_encode($row->id)]);
        ...
        return view('admin.contact_titles.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        {
            return view('admin.contact_titles.create');
        }
        ...
        try{
            ...
            DB::table('contact_titles')->insert($data);
    ...
    public function edit(Request $request)
    {
        ...
        if($request->isMethod('get'))
        {
            $new = DB::table('contact_titles')->where('id',$customer_id)->first();

            return view('admin.contact_titles.edit',compact('new'));
        }
        ...
        $about = DB::table('contact_titles')->where('id',$customer_id)->first();
        ...
        try{
            ...
            DB::table('contact_titles')->where('id',$customer_id)->update($data);
